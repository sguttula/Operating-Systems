...
/*
This directory listing server waits for clients to connect to it.
*/
...
//Start reading from the client socket.
 ...
 //The client starts sending commands to the disk server
   while(1){
	tk=sc=inlen=num=0;
 ...
 //the w command is recieved, it calculates the block to write to maps the file and writes to the file.
